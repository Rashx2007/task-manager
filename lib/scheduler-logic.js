...
const PRIORITY_RANK = { '0.آنی': 0, '1.خیلی بالا': 1, '2.بالا': 2, '3.متوسط': 3, '4.کم': 4, '5.خیلی کم': 5, 'نامشخص': 6 };
const rank = (p) => (PRIORITY_RANK[p] ?? 7);
...
// ✅ جدید: فقط کارهایی که شروع‌شان از نقطهٔ درج به بعد است؛ فیلتر و مرتب‌سازی در JS
...
// ✅ جدید: نقطهٔ درج = اولین کار با الویت پایین‌تر (رتبهٔ عددی)
...
// ✅ جدید: نقطهٔ درج از خودِ کار تغییر‌یافته خوانده می‌شود (امضای فراخوان بدون تغییر)
