  ...
  return (
    <div className="bg-[#5F7470] p-4 mx-4 mt-2 rounded-lg shadow-lg" dir="rtl">
      ...
      <form onSubmit={submit} className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <div><label className="text-white text-sm">سیستم مکانیکی</label><input className={inp} value={f.mechSystem} onChange={set('mechSystem')} /></div>
        <div><label className="text-white text-sm">نام دستگاه</label><input className={inp} value={f.assetName} onChange={set('assetName')} /></div>
        ...
        <div><label className="text-white text-sm">عنوان/موضوع</label><input className={inp} value={f.subject} onChange={set('subject')} /></div>
        ...
        <div><label className="text-white text-sm">قسمت (محل)</label><input className={inp} value={f.location} onChange={set('location')} /></div>
