          ...
          {tab === 'devices' && form === null && (
            <>
              ...
              <div className="flex flex-wrap gap-2 mb-3">
                ...
                {!onSelectAsset && (
  <button className="btn-primary" disabled={!selectedAsset} title={selectedAsset ? 'ایجاد کار جدید برای: ' + selectedAsset.AssetName : 'ابتدا یک دستگاه را از جدول انتخاب کنید'} onClick={() => onNewTaskWithAsset && onNewTaskWithAsset(selectedAsset.AssetID)}>➕ کار جدید با این دستگاه</button>
)}
              </div>
