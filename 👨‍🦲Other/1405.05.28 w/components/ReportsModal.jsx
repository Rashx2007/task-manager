...
const TYPES = {
  tasks_list: { label: 'گزارش لیست کارها', date: false, cols: [['TaskID','کد'],['AssetName','دستگاه/مجموعه'],['AssetNumber','شماره'],['Building','ساختمان'],['Location','محل'],['Block','بلوک'],['Floor','طبقه'],['TaskTtl','موضوع'],['Descriptions','توضیحات'],['Priorities','الویت'],['DueFa','زمان'],['SubmitFa','تاریخ ثبت']] },
  ...
  requests_undone: { label: 'گزارش خریدهای انجام‌نشده', date: false, cols: [['TaskID','کد کار'],['RequestNumber','شماره درخواست'],['RegisterNumber','شماره ثبت'],['Location','محل'],['TaskTtl','موضوع'],['Descriptions','شرح'],['RequestFa','تاریخ درخواست'],['Buyer','کارپرداز'],['Status','وضعیت'],['FundingFa','تاریخ تأمین'],['Priorities','الویت']] },
  ...
  undone_tasks: { label: 'گزارش کارهای در حال انجام', date: false, cols: [['TaskID','کد'],['AssetName','دستگاه'],['AssetNumber','شماره'],['Building','ساختمان'],['Location','محل'],['TaskTtl','عنوان'],['Descriptions','شرح'],['Priorities','الویت'],['DueFa','تاریخ شروع'],['EndFa','تاریخ اتمام']] },
  done_tasks: { label: 'گزارش کارهای اتمام‌یافته', date: false, cols: [['TaskID','کد'],['AssetName','دستگاه'],['AssetNumber','شماره'],['Building','ساختمان'],['Location','محل'],['TaskTtl','عنوان'],['Descriptions','شرح'],['Priorities','الویت'],['DueFa','تاریخ شروع'],['EndFa','تاریخ اتمام']] },
  tasks_functor: { label: 'گزارش انجام‌دهنده کارها', date: false, cols: [['TaskID','کد'],['Functor','انجام‌دهنده'],['AssetName','دستگاه'],['AssetNumber','شماره'],['Building','ساختمان'],['Location','محل'],['Priorities','الویت'],['TaskTtl','موضوع'],['DueFa','نوبت'],['SubmitFa','تاریخ ثبت']] },
  daily: { label: 'گزارش کار روزانه', date: true, cols: [['TaskID','کد'],['AssetName','دستگاه'],['AssetNumber','شماره'],['Building','ساختمان'],['Location','محل'],['TaskTtl','عنوان'],['Description','توضیحات'],['DoneFa','تاریخ انجام']] },
  considerable: { label: 'گزارش اقدامات و پروژه‌ها', date: true, cols: [['TaskID','کد'],['IsConsiderableAction','اقدام/پروژه'],['AssetName','دستگاه'],['AssetNumber','شماره'],['Building','ساختمان'],['Location','محل'],['TaskTtl','عنوان'],['SubmitFa','تاریخ ثبت'],['FinishFa','تاریخ اتمام'],['Complited','وضعیت']] },
  all_by_date: { label: 'گزارش کلی کارها بر اساس تاریخ', date: true, cols: [['TaskID','کد'],['IsConsiderableAction','اقدام/پروژه'],['AssetName','دستگاه'],['AssetNumber','شماره'],['Building','ساختمان'],['Location','محل'],['TaskTtl','عنوان'],['Descriptions','شرح'],['SubmitFa','تاریخ ثبت'],['FinishFa','تاریخ انجام'],['Complited','وضعیت']] },
  finished_by_date: { label: 'گزارش کارهای انجام‌شده بر اساس تاریخ', date: true, cols: [['TaskID','کد'],['IsConsiderableAction','اقدام/پروژه'],['AssetName','دستگاه'],['AssetNumber','شماره'],['Building','ساختمان'],['Location','محل'],['TaskTtl','عنوان'],['SubmitFa','تاریخ ثبت'],['FinishFa','تاریخ اتمام'],['Complited','وضعیت']] },
  // ✅ معادل Frm_Asset_Date_Task_Search + گزارش «بر اساس تاریخ و دستگاه»
  asset_date: { label: 'بر اساس تاریخ و دستگاه', date: true, asset: true, cols: [['TaskID','کد'],['AssetName','دستگاه'],['AssetNumber','شماره'],['Building','ساختمان'],['Location','محل'],['TaskTtl','موضوع'],['Descriptions','توضیحات'],['Priorities','الویت'],['StatusFa','وضعیت'],['SubmitFa','تاریخ ثبت'],['DueFa','زمان شروع'],['EndFa','زمان اتمام']] },
};
    ...
    try {
      if (type === 'asset_date') {
        const res = await fetch('/api/search', {
          ...
          body: JSON.stringify({ ...asset, status, start: start.toISOString(), end: endOfDay(end).toISOString() }),
        });
        const d = await res.json();
        if (d.success) {
          setRows(d.data.map((r) => ({
            ...r,
            DueFa: fmtFa(r.DueDateTime), EndFa: fmtFa(r.EndDateTime), SubmitFa: fmtFa(r.Submit_Date),
