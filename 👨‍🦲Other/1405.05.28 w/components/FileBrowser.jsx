...
// ✅ کارت فایل: تصویر برای عکس‌ها، نشان برای PDF/Word/Excel/نقشه و...
...
export default function FileBrowser({ mode = 'folder', initial = '', title, onSelect, onClose }) {
  const [view, setView] = useState('thumb'); // ✅ پیش‌فرض: بندانگشتی
      ...
      <div className="bg-[#CCE6DF] rounded-lg shadow-2xl w-[780px] max-w-full max-h-[90vh] flex flex-col">
        ...
        <div className="p-4 flex flex-col gap-3">
          <div className="flex items-center gap-2">
            ...
            <button className="btn-primary px-3" onClick={() => setView(view === 'thumb' ? 'list' : 'thumb')}
              title="تغییر نما: بندانگشتی / فهرست">{view === 'thumb' ? '☰' : '🖼️'}</button>
            {/* ✅ بازکردن/اجرا در ویندوز */}
