...
// ✅ پوشهٔ پیش‌فرض دستگاه‌ها مثل دسکتاپ (بک‌اسلش‌ها با \\ escapes شده‌اند)
...
export default function AssetsModal({ onClose, onNewTaskWithAsset }) {
            ...
            <>
              ...
              <div className="flex flex-wrap gap-2 mb-3">
                ...
                <button
                  ...
                  onClick={() => onNewTaskWithAsset && onNewTaskWithAsset(selectedAsset.AssetID)}
                >
              ...
              <div className="overflow-auto overscroll-contain rounded border border-gray-300" style={{ maxHeight: '52vh' }}>
                <table className="task-table w-full min-w-[1080px]">
                  <thead>
                    <tr>
                      <th>کد</th><th>دستگاه</th><th>شماره</th><th>ساختمان</th><th>بلوک</th><th>طبقه</th><th>ورودی</th><th>محل</th><th>سیستم</th><th>اموال</th><th>عملیات</th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    {filtered.map((a) => (
                      <tr
                        ...
                        className={selectedAsset?.AssetID === a.AssetID ? 'bg-[#FC7470]' : ''}
                      ...
                      >
                        ...
                        <td className="whitespace-nowrap">
                          <button className="btn-primary px-2 py-1 text-xs ml-1" onClick={() => startEdit(a)}>ویرایش</button>
                          <button className="btn-danger px-2 py-1 text-xs" onClick={() => del(a.AssetID)}>حذف</button>
                        </td>
                      </tr>
                    ))}
                  </tbody>
